...
OBJECTS = $(OBJDIR)/vanilla_attention.o $(OBJDIR)/serialised_attention.o
TESTOBJECTS = $(TESTSOBJDIR)/catch.o $(TESTSOBJDIR)/test_serialised_attention.o
...
$(TESTSOBJDIR)/test_serialised_attention.o: tests/cpp/test_serialised_attention.cpp
	$(CXX) $(CXXFLAGS) -Iflash_attention_ipu/cpp -Ithird_party/catch2/extras -c tests/cpp/test_serialised_attention.cpp -o $(TESTSOBJDIR)/test_serialised_attention.o
